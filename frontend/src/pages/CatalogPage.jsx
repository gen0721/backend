...
const CATEGORIES = [
  { slug:'', name:'Все' },
  { slug:'game-accounts', name:'Аккаунты', icon: <Gamepad2 size={18} strokeWidth={1.5} className="icon-animated icon-animated--subtle"/> },
  { slug:'game-currency', name:'Валюта', icon: <Coins size={18} strokeWidth={1.5} className="icon-animated icon-animated--subtle"/> },
  { slug:'items', name:'Предметы', icon: <Sword size={18} strokeWidth={1.5} className="icon-animated icon-animated--wiggle"/> },
  { slug:'skins', name:'Скины', icon: <Palette size={18} strokeWidth={1.5} className="icon-animated icon-animated--subtle"/> },
  { slug:'keys', name:'Ключи', icon: <KeyRound size={18} strokeWidth={1.5} className="icon-animated icon-animated--pop"/> },
  { slug:'subscriptions', name:'Подписки', icon: <Star size={18} strokeWidth={1.5} className="icon-animated icon-animated--pop"/> },
  { slug:'boost', name:'Буст', icon: <Rocket size={18} strokeWidth={1.5} className="icon-animated icon-animated--wiggle"/> },
  { slug:'other', name:'Прочее', icon: <Package size={18} strokeWidth={1.5} className="icon-animated icon-animated--subtle"/> },
]
      ...
      <div style={{ display:'flex', gap:8, flexWrap:'wrap', marginBottom:20 }}>
        {CATEGORIES.map(c => (
          <button
            ...
            style={{ cursor:'pointer', fontSize:13, fontWeight:700, fontFamily:'var(--font-h)' }}
          >
            {c.icon} {c.name}
          </button>
        ))}
